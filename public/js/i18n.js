...
window.I18N = (function () {
  const DICT = {
    ...
    "confirm.folderMessage": { en: "You are about to upload {count} files (~{size} MB). This may take a moment depending on your connection.", fa: "قراره {count} فایل (حدود {size} مگابایت) آپلود شود. بسته به سرعت اینترنتتان ممکن است کمی طول بکشد." },
